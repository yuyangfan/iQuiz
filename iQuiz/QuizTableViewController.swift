...
class QuizTableViewController: UITableViewController {
    ...
    // MARK: Properties
    var quizes : [String] = ["Mathematics","Marvel Super Heros","Science"]
    var descriptions : [String] = ["Test your math skills", "How many Marvel heros do you know", "All about natural science"]
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.nameLabel.text = quizes[indexPath.row]
        ...
        cell.descriptions.text = descriptions[indexPath.row]
